...
class VirtualDataSource_News {
    ...
    public static function getNewsByCategory($id_category) {
        return array_filter(self::$news_list, function ($item) use ($id_category) {
           return $item['id_category'] == $id_category;
        });
    }

    public static function getNewsByIdAndCategory($id_category, $id_news) {
        $arr = array_filter(self::$news_list, function ($item) use ($id_news, $id_category) {
