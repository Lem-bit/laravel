...
@section('title_name', 'Добавить группу')
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="title" type="text" placeholder="<название категории>" aria-label="default input example" value="{{ old('title') }}">
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="slug" type="text" placeholder="<слаг>" aria-label="default input example" value="{{ old('slug') }}">
